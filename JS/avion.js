...
// Fichier séparé: avion.js
// Dépendances: un élément <img id="flyerGif"> présent dans le DOM,
// et (optionnel) un menu avec id="menu" pour armer un vol à la navigation.
// Styles requis: les règles CSS pour #flyerGif (déjà dans style.css).
