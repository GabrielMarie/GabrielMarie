...
<head>
    <meta charset="UTF-8">
    <title>Gabriel Marie - Expédition</title>
    <meta name="description" content="Site personnel de Gabriel Marie - exploration Côte-Nord Lac bebord et Nipisso. Découvrez les récits de mes expéditions à la recherche de cratères de météorites et de traces culturelles autochtones.">
    <meta name="keywords" content="Lac Debor, Lac Nipisso, Debor, météorite, Côte-Nord, Nipisso, le site de Gab, lesitedegab, LeSiteDeGab, Griel Marie, Gabriel Lavoie-St-Gelais, Lavoie-St-Gelais, St-Gelais">
...
<section class="sujet">
    <p>Je suis l'explorateur Gabriel Marie ! J'explore en solitaire les territoires intérieurs de la Côte-Nord à la recherche de cratères de météorites. Mais, étonnamment, je trouve plus de reliques autochtones que de cratères, ce qui n'est malheureusement pas mon objectif.</p>

    <p>J'ai toutes les photos de mes expéditions sur mon site internet Flickr, classées par expédition.</p>
...
<section id="index">
    <h2>Sommaire</h2>
        <div class="sommaire">
            <a href="#sujet3">Expédition Nipisso Nord - Été 2025</a><br>            
            <a href="#sujet2">Expédition Été 2024</a><br>
            <a href="#sujet1">Expédition Été 2021</a><br>
        </div>
</section>
        ...
        <section id="sujet3" class="sujet">
            <h2>Expédition Lac Nipisso Nord - Été 2025</h2>
            <p> </p>

    </p>
        <div class="illustration">
            <img src="images/expedition2025profile.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">Dehors, les loups hurlaient quelque part au loin. Et le vent leur répondait. </p>
        </div>
    <p>
  ...
  <div id="journal-entry">
    ...
    <div class="entry active" data-day="1">
  <div class="controls controls-top">
    <button onclick="previousEntry()"> </button>
    <button onclick="nextEntry()">→</button>
  </div>
    <p>  
        <strong>29 mai 2025 — Jour 1</strong><br>
        ...
        <div class="illustration">
            <img src="images/expedition2025fatigue.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">...chaque arrêt était une négociation entre la fatigue et la volonté. J’ai dû prendre plusieurs pauses, souvent.</p>
        </div>
    <p>
        ...
        <div class="illustration">
            <img src="images/expedition2025j1.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
        </div>
    <p>
    <div class="controls">
  <button onclick="previousEntry()"> </button>
  <button onclick="nextEntry()">→</button>
    ...
    <div class="entry hidden" data-day="2">
  <div class="controls controls-top">
    <button onclick="previousEntry()">←</button>
    <button onclick="nextEntry()">→</button>
  </div>
    <p>
        <strong>30 mai 2025 — Jour 2 de l’expédition Nipisso Nord</strong><br>
        Journal de l'explorateur Gabriel Marie
        <br><br>
        ...
        <div class="illustration">
            <img src="images/expedition2025lac1.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">Le lac était d’un calme absolu.</p>
        </div>
    <p>
  ...
  <button onclick="nextEntry()">→</button>
    ...
    <div class="entry hidden" data-day="3">
  ...
  <div class="controls controls-top">
    ...
    <p>
        <strong>31 mai 2025 — Jour 3 de l’expédition Nipisso Nord</strong><br> 
        Journal de l'explorateur Gabriel Marie
        <br><br>
        ...
        <div class="illustration">
            <img src="images/expedition2025barquerive.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">...mon regard s’est posé sur une seconde barque, laissée là elle aussi par d’anciens voyageurs.</p>
        </div>
    <p>
        ...
        <div class="illustration">
            <img src="images/expedition2025j3.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
        </div>
    <p>
    <div class="controls">
  <button onclick="previousEntry()">←</button>
  <button onclick="nextEntry()">→</button>
    ...
    <div class="entry hidden" data-day="4">
  <div class="controls controls-top">
    <button onclick="previousEntry()">←</button>
    <button onclick="nextEntry()">→</button>
  </div>
    <p>
        <strong>1 juin 2025 — Jour 4 de l’expédition Nipisso Nord</strong><br>
        Journal de l'explorateur Gabriel Marie
        <br><br>
  ...
  <div class="entry hidden" data-day="5">
  <div class="controls controls-top">
    <button onclick="previousEntry()">←</button>
    <button onclick="nextEntry()">→</button>
  </div>
    <p>
        <strong>2 juin 2025 — Jour 5 de l’expédition Nipisso Nord</strong><br>
        Journal de l'explorateur Gabriel Marie
        <br><br>
        ...
        <div class="illustration">
            <img src="images/expedition2025gaz.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">...ce sont des bidons d’huile ou de gaz laissés à traîner. </p>
        </div>
    <p>
        ...
        <div class="illustration">
            <img src="images/expedition2025j5.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
        </div>
    <p>
    <div class="controls">
  <button onclick="previousEntry()">←</button>
  ...
  <div class="entry hidden" data-day="6">
  <div class="controls controls-top">
    <button onclick="previousEntry()">←</button>
    <button onclick="nextEntry()">→</button>
  </div>
    <p>
        <strong>3 juin 2025 — Jour 6 de l’expédition Nipisso Nord</strong><br>
        Journal de l'explorateur Gabriel Marie
        <br><br>
        ...
        <div class="illustration">
            <img src="images/expedition2025paysage.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">Plus d’arbres, remplacé par une steppe de sable et de blocs erratiques. </p>
        </div>
    <p>
        ...
        <div class="illustration">
            <img src="images/expedition2025lacenfurry.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">Le courant me poussait, et les vagues m’arrivaient de côté.</p>
        </div>
    <p>
        ...
        <div class="illustration">
            <img src="images/expedition2025barque.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">Alors j’ai retourné la barque sur la rive pour m’en faire un abri...</p>
        </div>
    <p>
        ...
        <div class="illustration">
            <img src="images/expedition2025j6.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
        </div>
    <p>
    <div class="controls">
  <button onclick="previousEntry()">←</button>
  ...
  <div class="entry hidden" data-day="7">
  <div class="controls controls-top">
    <button onclick="previousEntry()">←</button>
    <button onclick="nextEntry()">→</button>
  </div>
      <p>
        <strong>4 juin 2025 — Jour 7 de l’expédition Nipisso Nord</strong> <br>
        Journal de l'explorateur Gabriel Marie
        <br><br>
        ...
        <div class="illustration">
            <img src="images/expedition2025lacmir.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">Le lac était de miroir. Lisse, étale, presque irréel. Une mer d’huile.</p>
        </div>
    <p>
  ...
  <div class="entry hidden" data-day="8">
  <div class="controls controls-top">
    <button onclick="previousEntry()">←</button>
    <button onclick="nextEntry()">→</button>
  </div>
    <p>
        <strong>5 juin 2025 — Jour 8 de l’expédition Nipisso Nord</strong> <br>
        Journal de l'explorateur Gabriel Marie
        <br><br>
        ...
        <div class="illustration">
            <img src="images/expedition2025chemin.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">Le sentier m’a ramené sur mes pas, tranquillement.</p>
        </div>
    <p>
        ...
        <br><br>
        Il s’exprimait : <strong>« Mourir n’est rien, ne pas vivre est atroce. »</strong> Dans cette expédition, j’ai vécu.
    </p>
    <div class="controls">
  <button onclick="previousEntry()">←</button>
  <button onclick="nextEntry()">→</button>
  ...
  <div class="entry hidden" data-day="9">
  <div class="controls controls-top">
    <button onclick="previousEntry()">←</button>
    <button onclick="nextEntry()">   </button>
  </div>
    <p>
        <strong>6 juin 2025 — Jour 9 de l’expédition Nipisso Nord</strong> <br>
        Journal de l'explorateur Gabriel Marie
        <br><br>
        ...
        <br><br>
        Alors il demande à l’alchimiste :<br>
        <strong>« Pourquoi m’avoir fait faire tout ce voyage ? »</strong><br><br>
        Et l’alchimiste répond :<br>
        <strong> « Les pyramides… Elles étaient belles, non ? »</strong>
        <br><br>
        Dans ma tête, je me suis répondu à moi-même :<br>
        <strong>« C’est vrai... Elle était belle, la nature. »</strong>
    </p>

         </p>
        <div class="illustration">
            <img src="images/expedition2025total.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">Intégral du trajet parcouru pendant l'expédition Nipisso Noth</p>
        </div>
    <p>
        <div class="controls">
  <button onclick="previousEntry()">←</button>
  <button onclick="nextEntry()"> </button>
        ...
        <div class="illustration">
            <img src="images/cartcheminnipisso.png" alt="DESCRIPTION DE L’IMAGE" style="width: 400px; height: auto;">
            <p class="caption">Le sentier m'a ramené sur mes pas, tranquillement.</p>
        </div>
    <p>
 ...
 <a href=https://flic.kr/s/aHBqjCi4gY target="_blank">
    <strong>Albume Expédition Été 2025 Nipisso Nord</strong>
            </a>
        ...
        <section id="sujet2" class="sujet">
            <h2>Expédition Lac Nipisso Été 2024</h2>
            <p> </p>




            <a href=https://www.flickr.com/photos/gabriel_marie/albums/72177720322283468 target="_blank">
                <strong>Albume Expédition Lac Nipisso Été 2024</strong>
            </a>
        </section>

        <section id="sujet1" class="sujet">
            <h2>Expédition Lac Debor Été 2021</h2>
            <p> </p>


            <a href=https://www.flickr.com/photos/gabriel_marie/albums/72177720322426766 target="_blank">
                <strong>Albume Expédition Lac Debor Été 2021</strong>
            </a>
        </section>
